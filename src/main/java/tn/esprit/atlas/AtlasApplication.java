...
import java.io.InputStream;
    ...
    public void start(Stage stage) throws IOException {
        ...
        if (inputStream == null) {
            ...
            stage.getIcons().add(icon); // Set the icon for the stage
        }

        // Set the scene
        stage.setScene(scene);

        // Maximize the window (like Google Chrome)
        stage.setMaximized(true); // This keeps the title bar, close button, and icon visible
